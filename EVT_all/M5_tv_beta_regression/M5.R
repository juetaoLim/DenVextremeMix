...
setwd("~/nBox/EVT_Singapore/EVT_SG3.0/M5_tv_beta_regression/functions/")
...
# Model 5 : normal bulk AR(3) + climate(4*3) + TV gpd regression
...
# time-varying beta
MCMC_M5 = mcmc_ldm(5000, y = y, x1 = Xbulk4, x2 = Xextre)     # set threshold prior = 0.6
MCMC_M5_0.5 = mcmc_ldm(5000, y = y, x1 = Xbulk4, x2 = Xextre) # set threshold prior = 0.5. Remember change prior 
save.image("~/nBox/EVT_Singapore/EVT_SG3.0/M5_tv_beta_regression/out/out.RData")
